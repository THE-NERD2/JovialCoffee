...
import dev.the_nerd2.jovialcoffee.jastgen.ast.classes
import dev.the_nerd2.jovialcoffee.jastgen.ast.clearNClasses
...
fun forEachClass(block: (NClass) -> Unit) = classes.forEach(block)