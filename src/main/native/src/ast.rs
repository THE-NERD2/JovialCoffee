...
pub enum Node {
    ...
    NISub { left: Box<Node>, right: Box<Node> },
    ...
    NLDiv { left: Box<Node>, right: Box<Node> },
    NLCmp { left: Box<Node>, right: Box<Node> },
    NFAdd { left: Box<Node>, right: Box<Node> },
    NFSub { left: Box<Node>, right: Box<Node> },
    NFMul { left: Box<Node>, right: Box<Node> },
    NFDiv { left: Box<Node>, right: Box<Node> },
    NDAdd { left: Box<Node>, right: Box<Node> },
    NDSub { left: Box<Node>, right: Box<Node> },
    NDMul { left: Box<Node>, right: Box<Node> },
