...
extern "C" {
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_initCodegen() {
        ctx = make_unique<LLVMContext>();
        mod = make_unique<Module>("main", *ctx);
        builder = make_unique<IRBuilder<>>(*ctx);
    }
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_addClass(JNIEnv* env, jclass thiz, jobject clazz) {
    ...
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createClasses() {
        for(auto& [name, clazz] : classes) {
            clazz->createTypeBody();
        }
    }
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createMethod(JNIEnv* env, jclass thiz, jobject method) {
    ...
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createReference(JNIEnv* env, jclass thiz, jint id, jobject var) {
    ...
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createBoundReference(JNIEnv* env, jclass thiz, jint id, jint objId, jobject className, jobject field) {
    ...
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createBoundAssignment(JNIEnv* env, jclass thiz, jint objId, jobject className, jobject field, jint valueId) {
        jstring name = (jstring) className;
        const char* nameText = env->GetStringUTFChars(name, 0);
        string nameStr(nameText);
        env->ReleaseStringUTFChars(name, nameText);
    ...
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_createVoidReturn() {
        builder->CreateRetVoid();
    }
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_free(JNIEnv* env, jclass thiz, jint id) {
        tempValues.erase((int) id);
    }
    JNIEXPORT void JNICALL Java_dev_the_1nerd2_jovialcoffee_j2c_llvm_LLVM_emit() {
